	...
	const schema: IJSONSchema = {
		...
		properties: {
			...
			'use-inmemory-secretstorage': {
				type: 'boolean',
				description: localize('argv.useInMemorySecretStorage', "Ensures that an in-memory store will be used for secret storage instead of using the OS's credential store. This is often used when running editor extension tests or when you're experiencing difficulties with the credential store.")
			},
