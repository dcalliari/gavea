...
export class BrowserViewWorkbenchService extends Disposable implements IBrowserViewWorkbenchService {
	...
	readonly onDidChangeSharingAvailable: Event<boolean> = Event.None;
	 ...
	 */
	private async _openEditorForCreatedView(view: BrowserEditorInput, _owner: IBrowserViewOwner, openOptions: IBrowserViewOpenOptions): Promise<void> {
